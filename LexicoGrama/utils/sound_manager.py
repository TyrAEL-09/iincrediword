...
class SoundManager:
    ...
    def __init__(self, sound_correct_path: str, sound_incorrect_path: str, music_bg_path: str):
        ...
        self._music_paused_by_system = False # Para diferenciar la pausa del juego
    ...
    def start_music(self):
        ...
        if self._music_bg_path:
            try:
                ...
                self._music_paused_by_system = False
            except pygame.error as e:
    ...
    def pause_music(self):
        ...
        if pygame.mixer.music.get_busy():
            ...
            self._music_paused_by_system = True
            print("Música de fondo pausada.")

    def unpause_music(self):
        """Reanuda la música de fondo."""
        if self._music_paused_by_system:
    ...
    def get_music_status_text(self) -> str:
        ...
        if not self._music_bg_path:
            ...
            return "Música: ON"
        elif self._music_paused_by_system:
            return "Música: PAUSA" # Se puede agregar un estado de "PAUSA" explícito
        else:
            return "Música: OFF"